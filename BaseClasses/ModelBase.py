    ...
    def _init_model(self):
        ...
        try:
            ...
            try:
                ...
                self.Model = loader().loadModel("Models/Simple Geometry/cube.ply")
...
class EnterpriseModel(ShipModel):
    def __init__(self) -> None:
        super().__init__("/Users/Robin/Desktop/Projects/AstusGameEngine_dev/3DModels/NCC-1701-D.gltf")
